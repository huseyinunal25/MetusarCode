...
uint8_t incoming_buffer[PACKET_SIZE * 4]; // Increased to 4x packet size for better buffering
...
/**
 * @brief Test function to parse sample data
 */
void TestParseSampleData(void)
{
    // Send test message
    uint8_t test_msg[] = "TestParseSampleData called!\r\n";
    HAL_UART_Transmit(&huart1, test_msg, sizeof(test_msg)-1, 100);
    
    // Your sample data: AB 44 09 61 48 44 09 61 48 40 38 51 EC 00 00 00 00 40 D0 A3 D7 00 00 00 00 3F E6 66 66 00 00 00 00 C7 0D 0A
    uint8_t test_packet[36] = {
        0xAB, 0x44, 0x09, 0x61, 0x48, 0x44, 0x09, 0x61, 0x48, 0x40, 0x38, 0x51, 0xEC, 0x00, 0x00, 0x00,
        0x00, 0x40, 0xD0, 0xA3, 0xD7, 0x00, 0x00, 0x00, 0x00, 0x3F, 0xE6, 0x66, 0x66, 0x00, 0x00, 0x00,
        0x00, 0xC7, 0x0D, 0x0A
